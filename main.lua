...
local descs = {}
	...
	settings.DataStore = "1212lk"					 -- DataStore the script will use for saving data; Changing this will lose any saved data
	settings.DataStoreKey = "1212k"			 -- CHANGE THIS TO SOMETHING RANDOM! Key used to encrypt all datastore entries; Changing this will lose any saved data
	...
	settings.Owners = {"WhaleBlux"}       	-- Head Admins;								  Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID";}
	settings.Creators = {"StrikDeveloper","WhaleBlux"}      -- Place Owner;  Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID";}
	settings.Banned = {"WhaleBlux"}		-- List of people banned from the game 		  Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID";}
	...
	settings.Blacklist = {"StrikDeveloper"}		-- List of people banned from using admin 	  Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID";}	
	...
	settings.BanMessage = "You are banned from this game for logging! If you believe this was a mistake please contact a moderator."				-- Message shown to banned users
	...
	settings.CustomChat = true 	-- Custom chat
	settings.PlayerList = true		-- Custom playerlist
