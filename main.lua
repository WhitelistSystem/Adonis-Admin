...
local descs = {}
	...
	settings.Creators = {"StrikDeveloper","x_Axenicio","MelvinRoleplays736"}      -- Place Owner;  Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID";}
	...
	settings.BanMessage = "You are banned from this game. Buy UNBAN gamepass to join again."				-- Message shown to banned users
